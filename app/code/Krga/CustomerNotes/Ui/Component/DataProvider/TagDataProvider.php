...
class TagDataProvider extends DataProvider {
    ...
    public function getData()
    {
        ...
        foreach ($collection as $tag) {
            ...
            $items[] = [
                'tag_id' => $tag->getTagId(),
                'name' => $tag->getName(),
                'count' => $this->getNumberOfNotes($tag),
    ...
    public function getNumberOfNotes($tag) {
        $numberOfNotes = $this->tagRelationCollectionFactory->create()->addFieldToFilter('tag_id', ['eq' => $tag->getTagId()])->getItems();
